...
// CHECK: rodata[0]: byte 116, 101, 115, 116, 115, 47, 97, 115, 115, 101, 109, 98, 108, 121, 47, 100, 97, 116, 97, 95, 114, 101, 108, 95, 114, 111, 95, 108, 100, 100, 119, 46, 114, 115, 0, 0, 0, 0, 0, 0
// CHECK: rodata[40]: byte {{.*}}, 34, 0, 0, 0, 0, 0, 0, 0, 48, 0, 0, 0, 7, 0, 0, 0
// CHECK: rodata[64]: byte {{.*}}, 34, 0, 0, 0, 0, 0, 0, 0, 48, 0, 0, 0, 20, 0, 0, 0
// CHECK: rodata-relocation[40] -> rodata[0]
// CHECK: rodata-relocation[64] -> rodata[0]
// CHECK: lddw r{{[0-9]+}}, rodata[40]
// CHECK: lddw r{{[0-9]+}}, rodata[64]
